...
namespace MyPortfolio.Controllers
{
    public class PortfoliosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Image,Title,Technology,Link")] Portfolio portfolio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Image,Title,Technology,Link")] Portfolio portfolio)
        {
            if (id != portfolio.Id)
            {
                return NotFound();
